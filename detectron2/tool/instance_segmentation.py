...
# !unzip balloon_dataset.zip > /dev/null  # 将标准输出重定向到空设备, 解压到本地
...
therefore we write a function to parse it and prepare it into detectron2's standard format. 
User should write such a function when using a dataset in custom format. See the tutorial for more details.
'''
...
# To verify the data loading is correct, let's visualize the annotations of randomly
# selected samples in the training set:
...
# it will print the structure of model
