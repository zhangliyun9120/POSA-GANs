    ...
    def __init__(self, image_dir, instances_json, stuff_json=None,
        ...
        if stuff_data:
            ...
            for object_data in stuff_data['annotations']:
                ...
                if box_ok and category_ok and other_ok:
                    self.image_id_to_objects[image_id].append(object_data)
            # only process the images with stuff
            if stuff_only:
                new_image_ids = []
...
def get_dataloader(batch_size=10, COCO_DIR='../datasets/coco', instance_whitelist=None, stuff_whitelist=None, coco_include_other=False):
...
if __name__ == '__main__':
    train_loader, val_loader = get_dataloader(batch_size=1, COCO_DIR='../../datasets/coco')
